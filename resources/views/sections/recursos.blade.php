<div class="flex flex-col gap-10">
    <div class="flex justify-between items-center w-full">
        <img src="{{ asset('image/url.png') }}" alt="Ilustração de uma URL sendo encurtada" class="w-full max-w-md rounded-lg shadow-lg">
        <div class="max-w-[500px]">
            <h2 class="text-3xl font-medium mb-2">Redirecione links de forma simples e rápida</h2>
    ...
    <div class="flex justify-between items-center w-full">
        <div class="max-w-[500px]">
            <h2 class="text-3xl font-medium mb-2">Links curtos, decisões mais rápidas.</h2>
            <p class="text-gray-800 mt-10">
