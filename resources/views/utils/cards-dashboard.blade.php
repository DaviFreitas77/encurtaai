            ...
            <div class="flex w-full justify-between items-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
                    <g>
                        ...
                        <path
                            d="M18.364 15.536L16.95 14.12l1.414-1.414a5 5 0 1 0-7.071-7.071L9.88 7.05 8.465 5.636 9.88 4.222a7 7 0 0 1 9.9 9.9l-1.416 1.414zm-2.828 2.828l-1.414 1.414a7 7 0 0 1-9.9-9.9l1.416-1.414L7.05 9.88l-1.414 1.414a5 5 0 1 0 7.071 7.071l1.414-1.414 1.414 1.414z" />
    ...
    <div class="w-full">
        <div class="mt-10 grid grid-cols-2 md:grid-cols-2 xl:grid-cols-4 w-full gap-1">
            ...
            <div class="bg-[var(--color-secondary)] p-4 flex flex-col gap-1  rounded-md justify-between w-full">
                <div class="flex w-full justify-between items-center">
                    <p class="text-base ">Total Acessos</p>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                        fill="currentColor">
                        <g>
                            <path d="M0 0h24v24H0z" fill="none" />
