<div>
    <div class="flex flex-col mb-2">
        ...
        <div class="flex flex-col sm:flex-row gap-3 mt-4">
            <button
                class="bg-white border border-gray-200 w-full flex items-center justify-center gap-2 px-4 py-2  rounded-sm hover:bg-gray-100 transition font-medium mt-4 ">
    ...
    <form id="form-login" class="modal-content w-full text-sm" method="POST" action="{{route('login')}}">
        ...
        <div class="flex w-full">
            <button id="button-login" type="submit"
                class="bg-[var(--color-primary)] transition-colors text-white px-6 py-2 rounded-sm font-semibold w-full cursor-pointer hover:opacity-90">Entrar</button>
        </div>
