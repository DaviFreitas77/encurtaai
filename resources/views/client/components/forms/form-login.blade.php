  ...
  <section class="w-full max-w-150 p-6">
    <div class="flex flex-col mb-2 w-full">
      ...
      <div class="flex flex-col sm:flex-row gap-3 mt-4 w-full">
        <button class="bg-white border border-gray-200 w-full flex items-center justify-center gap-2 px-4 py-4   rounded-sm hover:bg-gray-100 transition font-medium mt-4 ">
