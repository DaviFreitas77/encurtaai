<div>
    <div class="flex flex-col mb-2">
        <h2 class="mt-4 text-xl font-bold">Crie sua conta</h2>
        <p class="text-sm text-gray-600 mt-2">
            Preencha os campos abaixo para começar a usar a plataforma.
        </p>
        <div class="flex flex-col sm:flex-row gap-3 mt-4 text-sm">
            <button
                class="bg-white border border-gray-200 w-full flex items-center justify-center gap-2 px-4 py-2  rounded-sm hover:bg-gray-100 transition font-medium mt-4 text-sm">
            ...
            <button
                class="bg-gray-800 text-white w-full flex items-center justify-center gap-2 px-4 py-2   rounded-sm hover:bg-gray-700 transition font-medium mt-4">
    ...
    <form id="form-register" class="modal-content w-full text-sm" method="POST" action="{{ route('register') }}">
        ...
        <div class="flex flex-col gap-4 mb-2">
            <div class="w-full">
                <input name="name" type="text"
                    class="px-3 py-2 border border-gray-200 rounded focus:ring-2 focus:ring-primary outline-none w-full"
                    placeholder="Nome">
        ...
        <div class="flex w-full">
            <button id="button-register" type="submit"
                class="bg-[var(--color-primary)] transition-colors text-white px-6 py-2 rounded-sm font-semibold w-full cursor-pointer hover:opacity-90">Registrar</button>
        </div>
