  ...
  <section class="w-full max-w-150 p-6">
    ...
    <form id="form-register" class="modal-content w-full text-sm" method="POST" action="{{ route('register') }}">
      ...
      <div class="flex flex-col gap-4 mb-2">
        <div class="w-full">
          <input name="name" type="text" class="px-3 py-4 border border-gray-200 rounded focus:ring-1 ring-[#16253b] outline-none w-full transition-all duration-250 ease-in" placeholder="Nome">
          <p data-error-for="name" class="text-red-500 text-sm mt-1"></p>
        </div>
        <div class="w-full">
          <input name="email" type="email" class="px-3 py-4 border border-gray-200 rounded focus:ring-1 ring-[#16253b] outline-none w-full transition-all duration-250 ease-in" placeholder="E-mail">
          <p data-error-for="email" class="text-red-500 text-sm mt-1"></p>
        </div>
        <div class="w-full">
          <input name="password" type="password" class="px-3 py-4 border border-gray-200 rounded focus:ring-1 ring-[#16253b] outline-none w-full transition-all duration-250 ease-in" placeholder="Senha">
